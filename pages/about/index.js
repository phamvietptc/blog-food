  ...
  return (
    <>
      <div className="my-6 md:my-12">
        <h5 className="text-black text-2xl leading-tight font-bold font-serif py-4 my-0 md:text-4xl">
          About
        </h5>
        <div class="detail">
          <hr className="h-px my-0 opacity-50 md:my-6" />
          <br />
          <h2 className="text-black text-2xl leading-tight font-bold font-serif mt-0 mb-2 md:text-6xl md:leading-tight">
          ...
          <br />
          <br />
          <p className="text-black font-sans text-sm leading-6 font-normal mt-0 mb-4 md:text-2xl md:leading-9 ">
        ...
        <div className="pt-4 mt-6 md:pt-6 md:mt-12">
          <h2 className="text-black text-2xl font-bold leading-tight font-serif pr-0 mt-0 mb-2 md:text-6xl md:leading-tight md:pr-12">
              ...
              <div key={index} className={AboutStyles.boxChefs}>
                <div className="mb-10 text-center">
                  ...
                  <div className="mt-2 md:mt-4">
                    <h6 className="text-black text-sm font-medium leading-tight font-sans my-0 md:text-base">
                      {item.name}
                    </h6>
                    <small className="text-slate-500 text-xs font-sans font-normal leading-3 block mt-1 md:leading-6">
                      {item.position}
                    </small>
                  </div>
                </div>
      ...
      <div className="py-1 my-1 md:py-12 md:my-12">
        <div className={AboutStyles.rowOperatring}>
          <div className={AboutStyles.leftOperatring}>
            <strong className="text-black text-sm leading-6 font-semibold font-sans mb-2 block md:text-base md:leading-6">
              Operatring from NYC, Dubai and London
            </strong>
            <small className="text-slate-800 text-xs font-sans leading-6 font-normal">
            ...
            <div className="items-center flex">
              <a href="" style={{ cursor: "pointer" }}>
                <Image
                  width="20px"
                  height="20px"
                  src="/icons/about/icons-facebook.svg"
                  alt=""
                />
              </a>
              <a href="" style={{ marginLeft: "1.5rem", cursor: "pointer" }}>
                <Image
                  width="20px"
                  height="20px"
                  src="/icons/about/icons-twitter.svg"
                  alt=""
                />
              </a>
              <a href="" style={{ marginLeft: "1.5rem", cursor: "pointer" }}>
                <Image
                  width="20px"
                  height="20px"
                  src="/icons/about/icons-instagram.svg"
                  alt=""
                />
              </a>
            </div>
