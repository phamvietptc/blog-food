                  ...
                  <Link href={`/home`}>
                    <a className="text-black text-base font-sans leading-normal font-medium block cursor-pointer px-2">
                      ...
                      <Image
                        width="15px"
                        height="15px"
                        src="/icons/navbar/icons-drop-down.png"
                        alt="Home Page"
                      />
                    </a>
                  </Link>
  ...
  return (
    <>
      <div className="md:hidden">
        ...
        <div
          className={`bg-slate-50 absolute top-0 inset-x-0 z-10 pb-6 outline-none ${hide}`}
        >
          <div className={NavbarStyles.containerSearch}>
            <div className="border-b border-black border-solid py-2 mb-2.5 flex items-center">
              <input
                ...
                id="Search"
                placeholder="Search..."
                className="bg-slate-50 text-lg font-normal leading-normal text-black outline-none flex-auto py-1.5 px-3"
              />
              <button
                onClick={() => {
                  setHide("hidden");
              ...
              >
                <Image
                  width="24px"
                  height="24px"
                  src="/icons/navbar/icons-close.svg"
                  alt="closed"
                />
              </button>
            </div>
            <div>
              <div>
                <a
                  href="#0"
                  className="flex flex-wrap border-b border-gray-200 border-solid items-center py-2"
                >
                  ...
                  <div className="w-4/5 pl-3.5">
                    <strong className="block font-sans text-base leading-5 text-black">
                      Cake
                    </strong>
                    <span className="block font-sans text-xs leading-normal font-normal text-black">
                      Category
                    </span>
                  </div>
                </a>
                ...
                >
                  <figure className="flex">
                    <Image
                      ...
                      src="/images/navbar/menuFood.jpg"
                      alt="Menu Food"
                    />
                  </figure>
                  <div className="w-4/5 pl-3.5">
              ...
              <div className="text-center py-6">
                <a className="font-sans text-black text-sm font-medium py-1 px-6 leading-normal text-center inline-block rounded border border-black border-solid hover:bg-black hover:text-white">
                  See all 343 results
                </a>
              </div>
            </div>
  ...
  return (
    <>
      <div className="dropdown dropdown-end">
        ...
        <ul
          tabIndex={0}
          className="mt-3 p-2 shadow menu menu-compact dropdown-content bg-primary-content rounded-box w-52"
        >
          <li>
            <a className="link link-hover text-neutral">Profile</a>
          </li>
          <li>
            <a className="link link-hover text-neutral">Settings</a>
          </li>
          <li>
            <a className="link link-hover text-neutral">Logout</a>
          </li>
        </ul>
      </div>
    </>
    ...
    <>
      <div className="md:hidden cursor-pointer pl-1.5 pr-0 ml-2">
        <div className="dropdown dropdown-end">
          <label
            tabIndex={0}
            className="border-transparent bg-inherit  swap swap-rotate"
          >
            <input type="checkbox" />
            <svg
              className="bg-inherit swap-off"
              xmlns="http://www.w3.org/2000/svg"
              width="24px"
              height="24px"
              viewBox="0 0 512 512"
          ...
          <ul
            tabIndex={0}
            className="mt-5 dropdown-content menu p-2 shadow bg-primary-content rounded-box w-52"
          >
            <li>
              <Link href={`/home`}>
      ...
      <div className={NavbarStyles.contentFooter}>
        <div className={NavbarStyles.containerFooter}>
          ...
          <div className="hidden md:block">
            <div className="text-black text-sm font-sans font-bold h-8 pr-24">
              Tastebite
            </div>
            <div
        ...
        <div>
          ...
          <div className={NavbarStyles.footerEnd}>
            <div className={NavbarStyles.copyright}>
              © 2022 Tastebite - All rights reserved
            </div>
            <div className={NavbarStyles.footerIcon}>
              <a className={NavbarStyles.footerIcon} href="" target="_blank">
                <Image
      ...
      <div className="md:hidden">
        {list.map((item, index) => (
          <div
            key={index}
            tabIndex={0}
            className="collapse collapse-arrow border-b outline-none"
          >
            <div className="collapse-title text-x font-medium text-neutral-focus">
              {item.title}
            </div>
            <div className="collapse-content">
              <Link href={item.link}>
                <p className="link link-hover text-neutral my-1.5">
                  {item.text}
                </p>
              </Link>
